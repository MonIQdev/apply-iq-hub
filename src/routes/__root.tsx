...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Find remote jobs, tailor your resume with AI, and track every application.",
      },
      { name: "author", content: "ApplyIQ" },
      { property: "og:title", content: "ApplyIQ — Apply to 10 Jobs in 60 Seconds" },
      {
        property: "og:description",
        content: "Find remote jobs, tailor your resume with AI, and track applications in one place.",
      },
